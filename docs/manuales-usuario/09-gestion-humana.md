...
- **Tabla de colaboradores**: nombre, documento, cargo, fecha de ingreso, inicio de contrato vigente, fecha de renovación/aviso, fin de contrato y estado (Indefinido / Vigente / etc.). Acciones por fila: **ver, editar, renovar, enviar correo, eliminar**.
...
1. En la pestaña **Consultar**, ubique al colaborador en la tabla.
