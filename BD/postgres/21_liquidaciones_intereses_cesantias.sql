-- Intereses sobre cesantías (Ley 52/1975): liquidación habitual en ciclo febrero sobre enero siguiente al año causado.
...
COMMENT ON COLUMN liquidaciones_nomina.incluye_intereses_cesantias IS 'febrero (+): inclusión ítem intereses cesantías en liquidación ordinaria';
