...
(function registerFeedbackMessages() {
  const F = {
    ...
    registerTerms: "Debe aceptar los términos, la política de privacidad y la Política de Tratamiento de Datos Personales para continuar.",
    dataPolicyRequired: "Debe aceptar la Política de Tratamiento de Datos Personales para continuar.",
    termsRequired: "Debe aceptar los Términos de uso y la Política de privacidad para continuar.",
    legalAcceptanceRequired: "Debe aceptar los documentos legales pendientes para continuar.",
    dataPolicyAccepted: "Política de tratamiento de datos registrada correctamente.",
    legalAcceptanceAccepted: "Documentos legales registrados correctamente.",
    ...
    sessionIdleBannerHint: "Vuelva a iniciar sesión para continuar.",
    ...
    interviewScheduledOk: "Entrevista programada. Cuando se realice, confirme para avanzar a Entrevistado.",
    interviewConfirmedOk: "Entrevista confirmada. El candidato avanzó a Entrevistado.",
    candidatePreselectedOk: "Candidato preseleccionado. Siguiente paso: agendar entrevista.",
